...
import classes from "./personalProfileLayout.module.css";
      ...
      <div className={classes.container}>
        ...
        <div className={classes.subContainer}>
          <div className={classes.leftContent}>
            <PesonalProfileCard  myProfile="true" />
          </div>
...
export default connect(null,mapDispatchToProps)(checkToken(PersonalProfileLayout));
